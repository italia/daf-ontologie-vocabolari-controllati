...
Il contenuto della directory Vocabolari Controllati è attualmente il seguente:
  ...
  + **Classificazioni per i servizi pubblici**: La directory contiene tutti vocabolari controllati, ad esclusione di quelli già definiti a livello Europeo per cui si rimanda ai relativi riferimenti, attualmente utilizzati per lo sviluppo del catalogo servizi pubblici.
